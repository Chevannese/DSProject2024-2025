...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        File fileUsers = new File("Usernames.txt");
        File filePatrons = new File("PatronRecords.xml");
        ...
        //Chev: Checks if file exists to prevent duplicated entries in file
        if(!filePatrons.exists())
        {
        ...
        for (String[] data : patronData) {
            ...
            Password.writePasswords(data[2], passwordStrings[Integer.parseInt(data[3])]);
            i++;
          }
        ...
        //Chev: Checks if the usernames file exists to prevent duplicate entries.
        if (!fileUsers.exists()) {
            for (String[] data : patronData) {
                Patron patron = new Patron();
                patron.setFname(data[0]);
        ...
        //Chev / Jada: Load and write book and patron data to XML files.
        if(!filePatrons.exists())
        {
        ...
        /*else
        {
           admin1.appendPatronData(patronsFileName,chev);
        }*/
